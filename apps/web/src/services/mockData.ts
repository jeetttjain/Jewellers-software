...
const STORAGE_KEY = 'kj_pos_local_store_v1';
...
export const defaultStoreData: LocalStoreData = {
  shop: {
    id: 'shop-kj-main-001',
  ...
  returns: [
    {
      ...
      authorizerName: 'Kamal Kishore Soni',
...
export class LocalStoreManager {
  ...
  private load(): LocalStoreData {
    if (typeof window === 'undefined') return defaultStoreData;
    try {
    ...
    return JSON.parse(JSON.stringify(defaultStoreData));
  }
  ...
  public getStore(): LocalStoreData {
    return this.data;
  }

  public reset(): void {
    this.data = JSON.parse(JSON.stringify(defaultStoreData));
    this.save();
  }
}
